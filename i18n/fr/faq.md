...
Le lead développeur du projet est [anonimal](https://github.com/anonimal), que vous pouvez contacter via les channels IRC [#kovri](irc://chat.freenode.net/#kovri) et [#kovri-dev](irc://chat.freenode.net/#kovri-dev), et via son [compte Twitter](https://twitter.com/whoisanonimal).
